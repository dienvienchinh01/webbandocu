    ...
    <header id="header">
       ...
       <div class=" alert alert-info alert-dismissible fade show" role="alert">
        ...
        <div class="strip d-flex justify-content-between px-4 py-1 bg-light">
            <p class="font-rale font-size-12 text-black-50 m-0">Shop Nuoc Hoa - 0763651041 - Việt Nam</p>
        ...
        <nav style=" background: #d83131;" class="navbar navbar-expand-lg navbar-dark color-header-bg">
            <a class="navbar-brand" href="./index.php">
                <img width="90" src="./assets/logo-nh.png" alt="logo" class="logo">
            </a>
